...
import com.hj.educenter.utils.ConstantPropertiesUtil;
import com.hj.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        try {
            ...
            throw new SLException(20001, e.getMessage());
        }
    ...
    public String callback(String code, String state){
        ...
        try {
            ...
            throw new SLException(20001, "获取access_token失败");
        }
        ...
        if(member == null){
            ...
            try {
                ...
                throw new SLException(20001, "获取用户信息失败");
            }
